    ...
    async def книга_воина(self, ctx: Context):
        ...
        while True:
            ...
            if responce.component.label == 'Вперёд':
                ...
                await msg.edit(f"{ctx.author.display_name} откладывает книгу и берёт топор.")
                return
    ...
    async def книга_охотника(self, ctx: Context):
        ...
        while True:
            ...
            if responce.component.label == 'Вперёд':
                ...
                await msg.edit(f"{ctx.author.display_name} подбрасывает книгу в воздух и сбивает её метким выстрелом.")
                return
    ...
    async def книга_разбойника(self, ctx: Context):
        ...
        while True:
            ...
            if responce.component.label == 'Вперёд':
                ...
                await msg.edit(f"{ctx.author.display_name} продаёт книгу по выгодной цене.")
                return
    ...
    async def книга_паладина(self, ctx: Context):
        ...
        while True:
            ...
            if responce.component.label == 'Вперёд':
                ...
                await msg.edit(f"{ctx.author.display_name} делает пасс рукой, закрывает манускрипт и озаряется светом.")
                return
    ...
    async def книга_друида(self, ctx: Context):
        ...
        while True:
            ...
            if responce.component.label == 'Вперёд':
                ...
                await msg.edit(f"{ctx.author.display_name} принимает облик буревестника и улетает.")
                return
    ...
    async def книга_шамана(self, ctx: Context):
        ...
        while True:
            ...
            if responce.component.label == 'Вперёд':
                ...
                await msg.edit(f"{ctx.author.display_name} подкладывает книгу заклинаний под тотем, чтобы он не качался.")
                return
    ...
    async def книга_мага(self, ctx: Context):
        ...
        while True:
            ...
            if responce.component.label == 'Вперёд':
                ...
                await msg.edit(f"{ctx.author.display_name} аккуратно ставит книгу на полку.")
                return
    ...
    async def книга_жреца(self, ctx: Context):
        ...
        while True:
            ...
            if responce.component.label == 'Вперёд':
                ...
                await msg.edit(f"{ctx.author.display_name} отдаёт книгу нуждающимся.")
                return
    ...
    async def чёрная_книга(self, ctx: Context):
        ...
        while True:
            ...
            if responce.component.label == 'Вперёд':
                ...
                await msg.edit(f"{ctx.author.display_name} захлапывает книгу и злобно хохочет.")
                return
    ...
    async def книга_смерти(self, ctx: Context):
        ...
        while True:
            ...
            if responce.component.label == 'Вперёд':
                ...
                await msg.edit(f"{ctx.author.display_name} выкидывает книгу и забывает всё, что в ней было написано.")
                return
    ...
    async def книга_монаха(self, ctx: Context):
        ...
        while True:
            ...
            if responce.component.label == 'Вперёд':
                ...
                await msg.edit(f"{ctx.author.display_name} оставляет в книге закладку и убирает за пазуху.")
                return
        ...
        while True:
            ...
            if responce.component.label == 'Вперёд':
                ...
                if authbal>0:
                    ...
                    await msg.edit(f"Книга демонов кусает {ctx.author.display_name} за палец.\nОт неожиданности {ctx.author.mention} теряет одну монетку.")
                else:
                    await msg.edit(f"Книга демонов пытается укусить {ctx.author.display_name} за палец.")
                return
