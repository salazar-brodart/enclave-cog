...
class enclave(commands.Cog):
    ...
    async def напоминание(self, ctx: Context):
        ...
        msg2 = (":point_right_tone1: Если у вас есть роль <@&696014224442392717>, вы можете открыть его, прочитав инструкцию на канале <#696206573504036934>. Команды можно писать в <#603151774009786393>.")
